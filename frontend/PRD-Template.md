...
*This PRD template was automatically generated when creating your jolly-dragon-flit app. Please customize it based on your specific requirements using the Deep Mode PRD flow in SnapDev.*
